...
class KesselCheckServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckForUpdate = channel.unary_unary(
                '/kessel.relations.v1beta1.KesselCheckService/CheckForUpdate',
                request_serializer=kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateRequest.SerializeToString,
                response_deserializer=kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateResponse.FromString,
                _registered_method=True)
...
def add_KesselCheckServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckForUpdate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateRequest.FromString,
                    response_serializer=kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateResponse.SerializeToString,
            ),
    }
...
class KesselCheckService(object):
    ...
    def CheckForUpdate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/kessel.relations.v1beta1.KesselCheckService/CheckForUpdate',
            kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateRequest.SerializeToString,
            kessel_dot_relations_dot_v1beta1_dot_check__pb2.CheckForUpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
