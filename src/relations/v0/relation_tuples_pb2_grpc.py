...
class KesselTupleService(object):
    ...
    def CreateTuples(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kessel.relations.v0.KesselTupleService/CreateTuples',
    ...
    def ReadTuples(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/kessel.relations.v0.KesselTupleService/ReadTuples',
    ...
    def DeleteTuples(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kessel.relations.v0.KesselTupleService/DeleteTuples',
